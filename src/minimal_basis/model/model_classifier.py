...
class ActivationBarrierModel(torch.nn.Module):
    def __init__(
        self, num_node_features, hidden_channels, out_channels, num_global_features=1
    ):
        super().__init__()
...
class MessagePassingActivationBarrierModel(torch.nn.Module):
    def __init__(
        self,
...
class MessagePassingClassifierModel(torch.nn.Module):
    def __init__(
        self,
        num_node_features: int,
        num_edge_features: int,
        ...
        # An linear layer for the very end
        self.lin = Linear(num_global_features + num_node_features, out_channels)
