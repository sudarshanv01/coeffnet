...
from minimal_basis.data import InterpolateDiffDatapoint as Datapoint
...
class InterpolateDiffDataset(InMemoryDataset):
    def __init__(
        self,
        root,
        transform=None,
    ...
    def processed_file_names(self):
        return "interpolate_diff_data.pt"
